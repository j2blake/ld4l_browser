module Ld4lBrowserData
  module TripleStoreDrivers
    module BaseDriver
      ...
      #
      # Will raise Ld4lBrowserData::TripleStoreDrivers::IllegalStateError if the 
      # instance is not running, or if this is called from within a do_sparql or 
      # another do_ingest block.
      #
      def do_ingest()
      ...
      #
      # Will raise Ld4lBrowserData::TripleStoreDrivers::IllegalStateError if the 
      # instance is not running, or if this is called from within another do_sparql
      # or a do_ingest block.
      #
      def do_sparql()
        raise IllegalStateError.new("Triple-store is not started.") unless running?
        raise IllegalStateError.new("Already executing a #{@mode} block") if @mode
